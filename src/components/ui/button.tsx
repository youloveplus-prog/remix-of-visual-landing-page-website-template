  ...
  "relative inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-2xl text-sm font-medium ring-offset-background transition-[transform,box-shadow,background-color,border-color,color] duration-200 ease-[cubic-bezier(0.22,1,0.36,1)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-60 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        cta:
          "bg-brand-gradient text-primary-foreground shadow-md border border-primary/20 hover:shadow-premium hover:-translate-y-[1px] hover:brightness-[1.04]",
        premium:
          "group/btn relative overflow-hidden bg-premium-gradient text-white border border-white/15 shadow-premium hover:-translate-y-[1px] hover:brightness-[1.05] before:absolute before:inset-0 before:bg-[linear-gradient(110deg,transparent_25%,hsl(0_0%_100%/0.22)_45%,transparent_65%)] before:translate-x-[-120%] before:transition-transform before:duration-[900ms] before:ease-out hover:before:translate-x-[120%] after:absolute after:inset-x-3 after:top-0 after:h-px after:bg-gradient-to-r after:from-transparent after:via-white/40 after:to-transparent",
        "premium-outline":
