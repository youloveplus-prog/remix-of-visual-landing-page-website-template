      ...
      >
        ...
        <div className="flex flex-col items-center text-center">
          <WordRise
            ...
            className="editorial-display max-w-[18ch]"
          />

          <Reveal delay={EDITORIAL_DELAY.bodyAfterHeadline} className="w-full mt-10 lg:mt-14">
            <ParallaxLayer strength={EDITORIAL_PARALLAX.coverPullquote} factor={0.15}>
              <p className="editorial-pullquote max-w-[34ch] mx-auto">
          ...
          >
            <Button asChild variant="premium" size="xl" className="min-w-[14rem]">
              <Link to="/shop">
                Enter the library
                <ArrowUpRight className="h-4 w-4" />
              </Link>
            </Button>
            <Button asChild variant="premium-outline" size="xl" className="min-w-[14rem]">
              <Link to="/mentors">
